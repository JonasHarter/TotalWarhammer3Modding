...
local mct_mod = mct:register_mod("kafka_breaches")
...
option_breaches_count:set_text("Amount of created breaches");
option_breaches_count:set_tooltip_text("");
option_breaches_count:slider_set_min_max(0, 99);
option_breaches_count:slider_set_step_size(1);
option_breaches_count:set_default_value(5);
