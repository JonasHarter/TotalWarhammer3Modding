...
option_cbac_army_limit_player:slider_set_min_max(1, 99000)
option_cbac_army_limit_player:slider_set_step_size(1)
option_cbac_army_limit_player:set_default_value(70)
...
option_cbac_army_limit_ai:set_tooltip_text("The amount of points, that gets applied to the army limit for ai armies.\n" .. "[[col:yellow]]A smaller value will cause AI turns to take longer.[[/col]]")
option_cbac_army_limit_ai:slider_set_min_max(-99000, 99000)
option_cbac_army_limit_ai:slider_set_step_size(1)
option_cbac_army_limit_ai:set_default_value(0)
...
option_cbac_hero_cap:set_tooltip_text("The amount heroes allowed per army.\n" .. "[[col:yellow]]Applies to the player only.[[/col]]")
