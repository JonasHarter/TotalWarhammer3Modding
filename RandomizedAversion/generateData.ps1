...
$dbPackFilePath = "C:/Games/Steam/steamapps/common/Total War WARHAMMER III/data/db.pack"
...
$factionList = New-Object -TypeName "System.Collections.ArrayList"
$skipCounter = 0
...
New-Item -ItemType "file" -Path $factionToEffectJunctionFilePath -Force
New-Item -ItemType "file" -Path $effectBundlesToEffectsJunctionFilePath -Force
New-Item -ItemType "file" -Path $effectsFilePath -Force
